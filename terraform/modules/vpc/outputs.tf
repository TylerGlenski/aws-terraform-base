...
output "subnet_private_1c__zone" {
...
output "subnet_protected_1c__zone" {
...
output "subnet_vpn_1a__zone" {
  value = aws_subnet.vpn-1c.availability_zone
}

output "subnet_vpn_1b__zone" {
  value = aws_subnet.vpn-1b.availability_zone
}

output "subnet_vpn_1c__zone" {
  value = aws_subnet.vpn-1c.availability_zone
}